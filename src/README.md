...
### `fusion/`
- Intelligence Fusion  
- Corrélation multi‑sources, agrégation, scoring, consolidation décisionnelle.
...
### 📌 Notes
- Ce dossier est **strictement technique**.  
La doctrine, l’architecture et les organigrammes sont dans `docs/`.
